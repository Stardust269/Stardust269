...
| **20260715**（三月版） | `sql/run_all_20260715.sql` | **八月~十月** cohort（**cohort 五条件对齐 5401**；10 月目标 ~5401） |
...
### 三月样本（cohort 五条件对齐 5401，10 月 ~5401）
...
**口径**：cohort 五条件与 `verify_cohort_5401.sql` 一致（`crdt>=2w` + 5103 `no_balance_60` + 60天未提现 + `had_0_30/31_60`）。
